...
public class MRUtil {
	...
	public static void runTemplateWithBasePath(String tkName, int tkNum, Callable ca, String[] args)
		...
		if(null == args || args.length < 2){
			logger.error("Usage: " + tkName + " <in> [<in>...] <out>");
			System.exit(2);
		}
		int len = args.length;
	...
	private static Logger logger = LoggerFactory.getLogger(MRUtil.class);
	private MRUtil(){throw new UnsupportedOperationException("Construct MRUtil...");}
}
