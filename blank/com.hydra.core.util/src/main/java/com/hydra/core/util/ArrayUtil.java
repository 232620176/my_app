...
public final class ArrayUtil {
     ...
     * </p>
     * <p>
     * 描述: 将数组source中的对象from替换为to，如from不存在则不进行操作
     * </p>
     * 
     * @param <T> 数组source的类型
    ...
    /**
     * <p>
     * 方法名: newArrayByArrayClass
     * </p>
     * <p>
     * 描述: 按数组类型clazz和数组长度length生成新数组
     * </p>
     * 
