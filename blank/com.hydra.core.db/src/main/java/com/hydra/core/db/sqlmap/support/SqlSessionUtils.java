...
public final class SqlSessionUtils {
     ...
     * @throws TransientDataAccessResourceException if a transaction is active
     *             and the {@code SqlSessionFactory} is not using a
     ...
     * @param sessionFactory the SqlSessionFactory which the SqlSession was
     *            built with
    ...
    private static final class SqlSessionSynchronization extends TransactionSynchronizationAdapter {
        ...
        public void beforeCompletion() {
            ...
            if (!this.holder.isOpen()) {
                ...
                IOUtil.closeSilence(this.holder.getSqlSession());
            }
        }
