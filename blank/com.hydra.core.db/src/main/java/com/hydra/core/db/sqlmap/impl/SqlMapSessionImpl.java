...
public class SqlMapSessionImpl implements SqlMapSession {
	...
	static final Logger logger = LoggerFactory.getLogger(SqlMapSessionImpl.class);
	...
	SqlMapSessionImpl(SqlSession session, SqlSessionFactory sqlMapClient, PersistenceExceptionTranslator exceptionTranslator) {
	...
	public void queryWithRowHandler(final String statementName, final Object parameterObject,
			final ResultHandler rowHandler) throws DataAccessException {
