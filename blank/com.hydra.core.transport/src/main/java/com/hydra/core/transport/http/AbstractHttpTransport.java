...
public abstract class AbstractHttpTransport {
	 ...
	 */
	public abstract String doSubmit(String url, Map<String,Object> params, HttpMethodProcessor processor) throws Exception;
	...
	public static interface HttpMethodProcessor{
		Logger logger = LoggerFactory.getLogger(HttpMethodProcessor.class);
