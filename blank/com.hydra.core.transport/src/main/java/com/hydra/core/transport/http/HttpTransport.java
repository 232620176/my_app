...
public class HttpTransport extends AbstractHttpTransport {
    @Override
    public String doSubmit(String url, Map<String, Object> params, HttpMethodProcessor processor) throws Exception {
        //处理渠道号
        ...
        log.debug(MapUtil.get(params, Dict._PROCESSID) + " params: " + params);
    ...
    public static class SimplePostMethodProcessor implements HttpMethodProcessor {
         ...
         * @param params 参数列表
         * @return HttpMethod
         * @see com.lakala.mfs.service.transport.http.AbstractHttpTransport.
         * HttpMethodProcessor#process(java.lang.String, java.util.Map)
         */
        @Override
